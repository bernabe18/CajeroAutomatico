...
import com.leandro.banco.CuentaBancaria;
import com.leandro.mock.UltimosMovimientos;
...
public class CajeroAutomatico {
    private CuentaBancaria cuantaBancariaActual;
    ...
    protected void mostrarSaldo(){
        System.out.println( "Tu saldo es : "+cuantaBancariaActual.getSaldo());
    }
    ...
    private void mostrarMovmientos(ArrayList<String> movimientos){
